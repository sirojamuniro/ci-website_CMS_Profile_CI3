  ...
  <div id="home" class="intro route bg-image"
      ...
      <div class="intro-content display-table">
          <div class="table-cell">
              ...
              <br>
              <p>
                  <a href="blog" class="btn btn-lg btn-primary" role="button" aria-enable="true"><i class="fa fa-search"
                          aria-hidden="true"></i> Menuju Blog
                  </a>
              </p>
              ...
              <div class="col-md-4">
                  <div class="work-box">
                      <a href="<?php echo base_url() ?>assets_frontend/img/work-1.jpg" data-lightbox="gallery-mf">
                          <div class="work-img">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/work-1.jpg" alt=""
                                  class="img-fluid">
                          </div>
              ...
              <div class="col-md-4">
                  <div class="work-box">
                      <a href="<?php echo base_url() ?>assets_frontend/img/work-2.jpg" data-lightbox="gallery-mf">
                          <div class="work-img">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/work-2.jpg" alt=""
                                  class="img-fluid">
                          </div>
                          <div class="work-content">
                              <div class="row">
              ...
              <div class="col-md-4">
                  <div class="work-box">
                      <a href="<?php echo base_url() ?>assets_frontend/img/work-3.jpg" data-lightbox="gallery-mf">
                          <div class="work-img">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/work-3.jpg" alt=""
                                  class="img-fluid">
                          </div>
                          <div class="work-content">
                              <div class="row">
              ...
              <div class="col-md-4">
                  <div class="work-box">
                      <a href="<?php echo base_url() ?>assets_frontend/img/work-4.jpg" data-lightbox="gallery-mf">
                          <div class="work-img">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/work-4.jpg" alt=""
                                  class="img-fluid">
                          </div>
                          <div class="work-content">
                              <div class="row">
              ...
              <div class="col-md-4">
                  <div class="work-box">
                      <a href="<?php echo base_url() ?>assets_frontend/img/work-5.jpg" data-lightbox="gallery-mf">
                          <div class="work-img">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/work-5.jpg" alt=""
                                  class="img-fluid">
                          </div>
                          <div class="work-content">
                              <div class="row">
              ...
              <div class="col-md-4">
                  <div class="work-box">
                      <a href="<?php echo base_url() ?>assets_frontend/img/work-6.jpg" data-lightbox="gallery-mf">
                          <div class="work-img">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/work-6.jpg" alt=""
                                  class="img-fluid">
                          </div>
                          <div class="work-content">
                              <div class="row">
                  ...
                  <div id="testimonial-mf" class="owl-carousel owl-theme">
                      <div class="testimonial-box">
                          <div class="author-test">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/roja.jpg" alt=""
                      ...
                      <div class="testimonial-box">
                          <div class="author-test">
                              <img src="<?php echo base_url(); ?>assets_frontend/img/roja.jpg" alt=""
                                  class="rounded-circle b-shadow-a">
                              <span class="author">Siroja Muniro</span>
                          </div>
                          <div class="content-test">
                              <p class="description lead">
