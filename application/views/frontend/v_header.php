...
<head>
    <meta charset="utf-8">
    <title>Siroja - Muniro</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="<?php echo $meta_keyword ?>" name="keywords">
    <meta content="<?php echo $meta_description ?>" name="description">

    <!-- Favicons -->
    <link href="<?php echo base_url() . '/gambar/website/midpoint.png'; ?>" rel="icon">
...
<body id="page-top">
    ...
    <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
        <div class="container">
            ...
            <img src="<?php echo base_url() . '/gambar/website/midpoint.png'; ?>" width="70px" class="mr-3">

            <a class="navbar-brand js-scroll" href="#page-top">Siroja Muniro </a>
